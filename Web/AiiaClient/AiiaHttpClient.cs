...
public class AiiaHttpClient : IAiiaHttpClient
{
    ...
    {
        return CallApi<object, T>(url, null, HttpMethod.Get, "Basic",
            GenerateBasicAuthorizationHeaderValue(clientSecret));
    }
    ...
    public Task<TResponse> HttpPost<TRequest, TResponse>(string url,
        ...
        AiiaClientSecret clientSecret)
    {
        return CallApi<TRequest, TResponse>(url, body, HttpMethod.Post, "Basic",
            GenerateBasicAuthorizationHeaderValue(clientSecret));
    }
